...
const ProfileForm = ({ token, user, loading, inProgress, updateProfile }) => {
  ...
  const onSubmit = (data) => {
    inProgress(true);
    updateProfile(token, user.id, data);
    console.log(data);
  };
  ...
  return (
    ...
    >
      <div className="space-y-12">
        <div className="border-cyan border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <div className="flex w-full rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-600">
            ...
            <div className="col-span-full">
              ...
              <div
                style={background ? backgroundStyle : { background: null }}
                ...
                <div className="text-center">
                  ...
                  <div className="mt-4 flex text-sm leading-6 text-gray-600">
                    ...
                    >
                      ...
                      <input
                        id="file-upload"
                        {...register("background_cover")}
                        type="file"
                        onChange={backgroundPreview}
                        className="sr-only"
                      />
                    </label>
            ...
            <div className="sm:col-span-full">
              ...
              <div className="mt-2">
                <input
                  ...
                  type="email"
                  readOnly
                  className="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-500 focus:border-cyan-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-cyan-500 dark:focus:border-cyan-500"
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateProfile: (token, id, data) =>
      dispatch({ type: UPDATE_PROFILE, token, id, data }),
  };
};
